module.exports=(function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c17 = function(operator, right) { return parsertools.applyOperator(operator.join(""), right); },
        peg$c18 = "[",
        ...
        peg$c28 = function(median, percentage, digit) { return parsertools.createFromDigital(median, percentage, digit); },
        peg$c29 = function(measured, grade, interval) { return parsertools.createFromAnalogue(measured, grade, interval); },
        peg$c30 = "(",
        ...
        peg$c37 = function(median, derivation) { return parsertools.create(median, Math.abs(derivation)); },
        peg$c38 = { type: "other", description: "eine Zahl" },
        peg$c39 = null,
        peg$c40 = /^[0-9.]/,
        peg$c41 = { type: "class", value: "[0-9.]", description: "[0-9.]" },
        peg$c42 = function(sign, digits) { return sign === null ? parseFloat(digits.join("")) : (-1)*parseFloat(digits.join("")); },
